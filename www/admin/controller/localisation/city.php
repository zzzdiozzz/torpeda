...
class ControllerLocalisationCity extends Controller {
	...
	protected function getList() {
		...
		$data['insert'] = $this->url->link('localisation/city/add', 'user_token=' . $this->session->data['user_token'] . $url, true);
		$data['delete'] = $this->url->link('localisation/city/delete', 'user_token=' . $this->session->data['user_token'] . $url, true);
		$data['update'] = $this->url->link('localisation/city_update', 'user_token=' . $this->session->data['user_token'] . $url, true);
