...
class SimpleCheckout extends Simple {
    ...
    public function needLoadBlock($block) {
        if ($block == 'shipping' && $this->getSettingValue('quickOrder') && $this->getSettingValue('quickOrderIgnoreShipping')) {
            return false;
        }

        if ($block == 'payment' && $this->getSettingValue('quickOrder')) {
            return false;
        }
    ...
    public function canCreateOrder() {
        ...
        if ($this->getSettingValue('quickOrder')) {
            $asap = false;
        }
