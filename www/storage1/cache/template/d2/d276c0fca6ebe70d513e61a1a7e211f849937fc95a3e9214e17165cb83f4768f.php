...
/* extension/d_seo_module/d_seo_module/setting_script.twig */
class __TwigTemplate_f8423325f18d7bf2188fe485a39a10cda6b8fc1c6c0578f858ccab251aede85e extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t});
\t
\tif (\$('#tab-store > .sort-item').length) {
\t\ttinysort('#tab-store > .sort-item', {attr: 'data-sort-order'});
\t}
\t
\tif (\$('#tab-local > .sort-item').length) {
\t\ttinysort('#tab-local > .sort-item', {attr: 'data-sort-order'});
\t}
\t
\tif (\$('#tab-option > .sort-item').length) {
\t\ttinysort('#tab-option > .sort-item', {attr: 'data-sort-order'});
\t}
\t
...
";
    ...
    {
        return "extension/d_seo_module/d_seo_module/setting_script.twig";
    }
    ...
    {
        return array (  81 => 40,  67 => 29,  37 => 1,);
    }

    public function getSourceContext()
    {
        return new Source("", "extension/d_seo_module/d_seo_module/setting_script.twig", "");
    }
}
