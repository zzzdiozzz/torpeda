                ...
                if ($documents) {
                    ...
                    foreach($documents as $document) {
                        ...
                        if ($status_settings) {
                            ...
                            $this->model_checkout_order->addOrderHistory($orders[$document['Number']]['order_id'], $status_settings['store_status'], $sms_message, $notify, false, (isset($status_settings['customer_notification']) ? true : false), false);
